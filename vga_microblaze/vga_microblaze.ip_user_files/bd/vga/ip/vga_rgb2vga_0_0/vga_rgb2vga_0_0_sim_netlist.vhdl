...
-- Date        : Wed Feb  1 22:04:16 2023
-- Host        : LAPTOP-2K825080 running 64-bit major release  (build 9200)
-- Command     : write_vhdl -force -mode funcsim
--               d:/liulei/vga_microblaze/vga_microblaze/vga_microblaze.srcs/sources_1/bd/vga/ip/vga_rgb2vga_0_0/vga_rgb2vga_0_0_sim_netlist.vhdl
-- Design      : vga_rgb2vga_0_0
...
entity vga_rgb2vga_0_0_rgb2vga is
  port (
  ...
  attribute ORIG_REF_NAME of vga_rgb2vga_0_0_rgb2vga : entity is "rgb2vga";
end vga_rgb2vga_0_0_rgb2vga;

architecture STRUCTURE of vga_rgb2vga_0_0_rgb2vga is
...
entity vga_rgb2vga_0_0 is
  ...
  attribute NotValidForBitStream of vga_rgb2vga_0_0 : entity is true;
  attribute CHECK_LICENSE_TYPE : string;
  attribute CHECK_LICENSE_TYPE of vga_rgb2vga_0_0 : entity is "vga_rgb2vga_0_0,rgb2vga,{}";
  attribute downgradeipidentifiedwarnings : string;
  attribute downgradeipidentifiedwarnings of vga_rgb2vga_0_0 : entity is "yes";
  attribute x_core_info : string;
  attribute x_core_info of vga_rgb2vga_0_0 : entity is "rgb2vga,Vivado 2018.3";
end vga_rgb2vga_0_0;

architecture STRUCTURE of vga_rgb2vga_0_0 is
  attribute x_interface_info : string;
  attribute x_interface_info of PixelClk : signal is "xilinx.com:signal:clock:1.0 signal_clock CLK";
  attribute x_interface_parameter : string;
  attribute x_interface_parameter of PixelClk : signal is "XIL_INTERFACENAME signal_clock, ASSOCIATED_BUSIF vid_in, FREQ_HZ 100000000, PHASE 0.000, CLK_DOMAIN vga_axi_dynclk_0_0_PXL_CLK_O, INSERT_VIP 0";
...
begin
U0: entity work.vga_rgb2vga_0_0_rgb2vga
     port map (
      PixelClk => PixelClk,
