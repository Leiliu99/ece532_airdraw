...
(* CORE_GENERATION_INFO = "vga,IP_Integrator,{x_ipVendor=xilinx.com,x_ipLibrary=BlockDiagram,x_ipName=vga,x_ipVersion=1.00.a,x_ipLanguage=VERILOG,numBlks=26,numReposBlks=19,numNonXlnxBlks=2,numHierBlks=7,maxHierDepth=1,numSysgenBlks=0,numHlsBlks=0,numHdlrefBlks=0,numPkgbdBlks=0,bdsource=USER,da_axi4_cnt=4,da_board_cnt=4,da_clkrst_cnt=3,da_mb_cnt=1,synth_mode=OOC_per_IP}" *) (* HW_HANDOFF = "vga.hwdef" *) 
module vga
   (ddr2_sdram_addr,
    ddr2_sdram_ba,
    ddr2_sdram_cas_n,
  ...
  (* X_INTERFACE_INFO = "xilinx.com:signal:clock:1.0 CLK.SYS_CLK_I_0 CLK" *) (* X_INTERFACE_PARAMETER = "XIL_INTERFACENAME CLK.SYS_CLK_I_0, CLK_DOMAIN vga_sys_clk_i_0, FREQ_HZ 100015812, INSERT_VIP 0, PHASE 0.0" *) input sys_clk_i_0;
  output [3:0]vga_blue;
  ...
  wire sys_clk_i_0_1;
  wire [31:0]vga_M_AXI_MM2S_ARADDR;
  wire [1:0]vga_M_AXI_MM2S_ARBURST;
  wire [3:0]vga_M_AXI_MM2S_ARCACHE;
  wire [7:0]vga_M_AXI_MM2S_ARLEN;
  wire [2:0]vga_M_AXI_MM2S_ARPROT;
  wire vga_M_AXI_MM2S_ARREADY;
  wire [2:0]vga_M_AXI_MM2S_ARSIZE;
  wire [0:0]vga_M_AXI_MM2S_ARVALID;
  wire [63:0]vga_M_AXI_MM2S_RDATA;
  wire vga_M_AXI_MM2S_RLAST;
  wire [0:0]vga_M_AXI_MM2S_RREADY;
  wire [1:0]vga_M_AXI_MM2S_RRESP;
  wire vga_M_AXI_MM2S_RVALID;
  ...
  (* BMM_INFO_PROCESSOR = "microblaze-le > vga microblaze_0_local_memory/dlmb_bram_if_cntlr" *) 
  (* KEEP_HIERARCHY = "yes" *) 
  ...
  vga_mig_7series_0_0 mig_7series_0
  ...
  vga_smartconnect_0_0 smartconnect_0
       (.M00_AXI_araddr(smartconnect_0_M00_AXI_ARADDR),
        ...
        .S02_AXI_araddr(vga_M_AXI_MM2S_ARADDR),
        .S02_AXI_arburst(vga_M_AXI_MM2S_ARBURST),
        .S02_AXI_arcache(vga_M_AXI_MM2S_ARCACHE),
        .S02_AXI_arlen(vga_M_AXI_MM2S_ARLEN),
        .S02_AXI_arlock(1'b0),
        .S02_AXI_arprot(vga_M_AXI_MM2S_ARPROT),
        .S02_AXI_arqos({1'b0,1'b0,1'b0,1'b0}),
        .S02_AXI_arready(vga_M_AXI_MM2S_ARREADY),
        .S02_AXI_arsize(vga_M_AXI_MM2S_ARSIZE),
        .S02_AXI_arvalid(vga_M_AXI_MM2S_ARVALID),
        .S02_AXI_rdata(vga_M_AXI_MM2S_RDATA),
        .S02_AXI_rlast(vga_M_AXI_MM2S_RLAST),
        .S02_AXI_rready(vga_M_AXI_MM2S_RREADY),
        .S02_AXI_rresp(vga_M_AXI_MM2S_RRESP),
        .S02_AXI_rvalid(vga_M_AXI_MM2S_RVALID),
        .aclk(microblaze_0_Clk),
        .aclk1(mig_7series_0_ui_clk),
        .aresetn(rst_mig_7series_0_81M_peripheral_aresetn));
  vga_imp_149M1SW vga
       (.M_AXI_MM2S_araddr(vga_M_AXI_MM2S_ARADDR),
        .M_AXI_MM2S_arburst(vga_M_AXI_MM2S_ARBURST),
        .M_AXI_MM2S_arcache(vga_M_AXI_MM2S_ARCACHE),
        .M_AXI_MM2S_arlen(vga_M_AXI_MM2S_ARLEN),
        .M_AXI_MM2S_arprot(vga_M_AXI_MM2S_ARPROT),
        .M_AXI_MM2S_arready(vga_M_AXI_MM2S_ARREADY),
        .M_AXI_MM2S_arsize(vga_M_AXI_MM2S_ARSIZE),
        .M_AXI_MM2S_arvalid(vga_M_AXI_MM2S_ARVALID),
        .M_AXI_MM2S_rdata(vga_M_AXI_MM2S_RDATA),
        .M_AXI_MM2S_rlast(vga_M_AXI_MM2S_RLAST),
        .M_AXI_MM2S_rready(vga_M_AXI_MM2S_RREADY),
        .M_AXI_MM2S_rresp(vga_M_AXI_MM2S_RRESP),
        .M_AXI_MM2S_rvalid(vga_M_AXI_MM2S_RVALID),
