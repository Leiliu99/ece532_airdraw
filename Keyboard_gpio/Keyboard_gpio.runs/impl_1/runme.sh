...
HD_PWD='C:/ece532/keybaordgpio/Keyboard_gpio/Keyboard_gpio.runs/impl_1'
cd "$HD_PWD"
...
EAStep vivado -log PS2Receiver.vdi -applog -m64 -product Vivado -messageDb vivado.pb -mode batch -source PS2Receiver.tcl -notrace
